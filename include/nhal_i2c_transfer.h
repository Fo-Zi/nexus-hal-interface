 ...
 * @brief Defines the API for low-level SYNCHRONOUS I2C bus transfers in a Hardware Abstraction Layer (HAL).
 *
 * This header declares an API function for low-level synchronous (blocking) I2C bus transfers,
 * referencing structures and enums defined in `nhal_i2c_types.h` to facilitate complex I2C transactions,
