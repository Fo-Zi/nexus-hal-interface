...
public:
    ...
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_write, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, const uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_read, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_write_read_reg, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, const uint8_t *reg_address, size_t reg_len, uint8_t *data, size_t data_len));
    ...
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_write_async, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, const uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_read_async, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_write_read_reg_async, (struct nhal_i2c_context *ctx, nhal_i2c_address dev_address, const uint8_t *reg_address, size_t reg_len, uint8_t *data, size_t data_len));

    // Transfer operations
    MOCK_METHOD(nhal_result_t, nhal_i2c_master_perform_transfer, (struct nhal_i2c_context *ctx, nhal_i2c_transfer_op_t *ops, size_t num_ops));
