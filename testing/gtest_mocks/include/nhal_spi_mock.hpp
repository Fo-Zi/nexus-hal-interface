...
public:
    ...
    MOCK_METHOD(nhal_result_t, nhal_spi_master_write_async, (struct nhal_spi_context *ctx, const uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_spi_master_read_async, (struct nhal_spi_context *ctx, uint8_t *data, size_t len));
    MOCK_METHOD(nhal_result_t, nhal_spi_master_write_read_async, (struct nhal_spi_context *ctx, const uint8_t *tx_data, size_t tx_len, uint8_t *rx_data, size_t rx_len));
    ...
    MOCK_METHOD(nhal_result_t, nhal_spi_daisy_write_chain, (struct nhal_spi_daisy_context *daisy_ctx, const struct nhal_spi_daisy_device *devices, size_t num_devices));
    MOCK_METHOD(nhal_result_t, nhal_spi_daisy_read_chain, (struct nhal_spi_daisy_context *daisy_ctx, struct nhal_spi_daisy_device *devices, size_t num_devices));
    MOCK_METHOD(nhal_result_t, nhal_spi_daisy_write_uniform, (struct nhal_spi_daisy_context *daisy_ctx, const uint8_t *data, size_t data_per_device));
    MOCK_METHOD(nhal_result_t, nhal_spi_daisy_read_uniform, (struct nhal_spi_daisy_context *daisy_ctx, uint8_t *data, size_t data_per_device));
