...
public:
    ...
    MOCK_METHOD(nhal_result_t, nhal_uart_write, (struct nhal_uart_context *ctx, const uint8_t *data, size_t len, nhal_timeout_ms timeout));
    MOCK_METHOD(nhal_result_t, nhal_uart_read, (struct nhal_uart_context *ctx, uint8_t *data, size_t len, nhal_timeout_ms timeout));
    ...
    MOCK_METHOD(nhal_result_t, nhal_uart_write_async, (struct nhal_uart_context *ctx, const uint8_t *data, size_t len, nhal_timeout_ms timeout_ms));
    MOCK_METHOD(nhal_result_t, nhal_uart_read_async, (struct nhal_uart_context *ctx, uint8_t *data, size_t len, nhal_timeout_ms timeout_ms));
