...
extern "C" {
    ...
    nhal_result_t nhal_i2c_master_write(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, const uint8_t *data, size_t len, nhal_timeout_ms timeout) {
        return NhalI2cMock::instance().nhal_i2c_master_write(ctx, dev_address, data, len, timeout);
    }

    nhal_result_t nhal_i2c_master_read(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, uint8_t *data, size_t len, nhal_timeout_ms timeout) {
        return NhalI2cMock::instance().nhal_i2c_master_read(ctx, dev_address, data, len, timeout);
    }

    nhal_result_t nhal_i2c_master_write_read_reg(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, const uint8_t *reg_address, size_t reg_len, uint8_t *data, size_t data_len, nhal_timeout_ms timeout) {
    ...
    nhal_result_t nhal_i2c_master_write_async(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, const uint8_t *data, size_t len, nhal_timeout_ms timeout_ms) {
        return NhalI2cMock::instance().nhal_i2c_master_write_async(ctx, dev_address, data, len, timeout_ms);
    }

    nhal_result_t nhal_i2c_master_read_async(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, uint8_t *data, size_t len, nhal_timeout_ms timeout_ms) {
        return NhalI2cMock::instance().nhal_i2c_master_read_async(ctx, dev_address, data, len, timeout_ms);
    }

    nhal_result_t nhal_i2c_master_write_read_reg_async(struct nhal_i2c_context *ctx, nhal_i2c_slave_addr dev_address, const uint8_t *reg_address, size_t reg_len, uint8_t *data, size_t data_len, nhal_timeout_ms timeout_ms) {
